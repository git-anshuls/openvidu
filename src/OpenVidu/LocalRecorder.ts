  ...
  record(mimeType?: string): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      this.mediaRecorder.onstart = () => {
        logger.log(
          "MediaRecorder started (state=" + this.mediaRecorder.state + ")"
        );
      };
      ...
      this.mediaRecorder.onpause = () => {
        logger.log(
          "MediaRecorder paused (state=" + this.mediaRecorder.state + ")"
        );
      };

      this.mediaRecorder.onresume = () => {
        logger.log(
          "MediaRecorder resumed (state=" + this.mediaRecorder.state + ")"
        );
      };
