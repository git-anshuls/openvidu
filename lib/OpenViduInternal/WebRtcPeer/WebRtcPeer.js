...
var WebRtcPeer = /** @class */ (function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (platform.name === "Safari" &&
                ...
                _this.pc
                    ...
                    var _a;
                    logger.debug("Created SDP offer");
                    offer.sdp = (_a = offer.sdp) === null || _a === void 0 ? void 0 : _a.replace("minptime=10;useinbandfec=1", "stereo=1;sprop-stereo=1;maxaveragebitrate=128000;usedtx=1;cbr=1;useinbandfec=1;ptime=20;minptime=20;maxptime=20;maxplaybackrate=48000;sprop-maxcapturerate=48000;x-google-min-bitrate=128;x-google-max-bitrate=144");
                    return _this.pc.setLocalDescription(offer);
                })
                    .then(function () {
                    var localDescription = _this.pc.localDescription;
    ...
    WebRtcPeer.prototype.addIceConnectionStateChangeListener = function (otherId) {
        ...
        this.pc.oniceconnectionstatechange = function () {
            var iceConnectionState = _this.pc
                .iceConnectionState;
            switch (iceConnectionState) {
                case "disconnected":
                    // Possible network disconnection
                    logger.warn("IceConnectionState of RTCPeerConnection " +
                        _this.id +
                        " (" +
                        otherId +
                    ...
                    break;
                case "failed":
                    logger.error("IceConnectionState of RTCPeerConnection " +
                        _this.id +
                        " (" +
                        otherId +
                        ') to "failed"');
                    break;
                case "closed":
                    logger.log("IceConnectionState of RTCPeerConnection " +
                        _this.id +
                        " (" +
                        otherId +
                        ') change to "closed"');
