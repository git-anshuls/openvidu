...
var LocalRecorder = /** @class */ (function () {
    ...
    LocalRecorder.prototype.record = function (mimeType) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                logger.log("Starting local recording of stream '" +
        ...
        return new Promise(function (resolve, reject) {
            try {
                if (_this.state !== LocalRecorderState_1.LocalRecorderState.RECORDING) {
                    reject(Error("'LocalRecord.pause()' needs 'LocalRecord.state' to be 'RECORDING' (current value: '" +
                        _this.state +
    ...
    LocalRecorder.prototype.uploadAsBinary = function (endpoint, headers) {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.state !== LocalRecorderState_1.LocalRecorderState.FINISHED) {
                reject(Error("'LocalRecord.uploadAsBinary()' needs 'LocalRecord.state' to be 'FINISHED' (current value: '" +
                    _this.state +
                    "'). Call 'LocalRecorder.stop()' before"));
            }
            else {
    ...
    LocalRecorder.prototype.uploadAsMultipartfile = function (endpoint, headers) {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.state !== LocalRecorderState_1.LocalRecorderState.FINISHED) {
                reject(Error("'LocalRecord.uploadAsMultipartfile()' needs 'LocalRecord.state' to be 'FINISHED' (current value: '" +
                    _this.state +
                    "'). Call 'LocalRecorder.stop()' before"));
            }
            else {
