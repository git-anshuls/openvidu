                ...
                this.session.openvidu.sendRequest("streamPropertyChanged", {
                    ...
                    if (error) {
                        ...
                        _this.session.emitEvent("streamPropertyChanged", [
                            new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this.session, _this.stream, "audioActive", value, !value, "publishAudio"),
                        ]);
                        _this.emitEvent("streamPropertyChanged", [
                            new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this, _this.stream, "audioActive", value, !value, "publishAudio"),
                        ]);
                    }
                });
            }
            this.stream.audioActive = value;
            logger.info("'Publisher' has " +
            ...
            if (!!this.session && !!this.stream.streamId) {
                this.session.openvidu.sendRequest("streamPropertyChanged", {
                    ...
                    if (error) {
                        ...
                        _this.session.emitEvent("streamPropertyChanged", [
                            new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this.session, _this.stream, "videoActive", value, !value, "publishVideo"),
                        ]);
                        _this.emitEvent("streamPropertyChanged", [
                            new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this, _this.stream, "videoActive", value, !value, "publishVideo"),
                        ]);
                    }
                });
            }
        ...
        if (type === "streamCreated") {
            if (!!this.stream && this.stream.isLocalStreamPublished) {
                this.emitEvent("streamCreated", [
                    new StreamEvent_1.StreamEvent(false, this, "streamCreated", this.stream, ""),
                ]);
            }
            else {
                this.stream.ee.on("stream-created-by-publisher", function () {
                    _this.emitEvent("streamCreated", [
                        new StreamEvent_1.StreamEvent(false, _this, "streamCreated", _this.stream, ""),
                    ]);
                });
            }
        }
        if (type === "remoteVideoPlaying") {
            if (this.stream.displayMyRemote() &&
                ...
                this.emitEvent("remoteVideoPlaying", [
                    new VideoElementEvent_1.VideoElementEvent(this.videos[0].video, this, "remoteVideoPlaying"),
                ]);
            }
        }
        ...
        return new Promise(function (resolve, reject) {
            ...
            var successCallback = function (mediaStream) {
                ...
                if (!!mediaStream.getAudioTracks()[0]) {
                    var enabled = _this.stream.audioActive !== undefined &&
                ...
                if (!!mediaStream.getVideoTracks()[0]) {
                    var enabled = _this.stream.videoActive !== undefined &&
                        ...
                        _this.videoReference.addEventListener("loadedmetadata", function () {
                            ...
                            _this.screenShareResizeInterval = setInterval(function () {
                                var firefoxSettings = mediaStream
                                    .getVideoTracks()[0]
                                    .getSettings();
                                var newWidth = platform.name === "Chrome" || platform.name === "Opera"
                                    ? _this.videoReference.videoWidth
                                    : firefoxSettings.width;
                                var newHeight = platform.name === "Chrome" || platform.name === "Opera"
                                ...
                                if (_this.stream.isLocalStreamPublished &&
                                    ...
                                    _this.session.openvidu.sendRequest("streamPropertyChanged", {
                                        ...
                                        if (error) {
                                            ...
                                            _this.session.emitEvent("streamPropertyChanged", [
                                                new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this.session, _this.stream, "videoDimensions", _this.stream.videoDimensions, oldValue_1, "screenResized"),
                                            ]);
                                            _this.emitEvent("streamPropertyChanged", [
                                                new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this, _this.stream, "videoDimensions", _this.stream.videoDimensions, oldValue_1, "screenResized"),
                                            ]);
                                        }
                                    });
                                }
