...
var OpenVidu = /** @class */ (function () {
                            ...
                            return new Promise(function (resolve, reject) {
                                if (platform["isIonicIos"]) {
                                    ...
                                    resolve({
                                        ...
                                        newHeight: publisher.stream.streamManager.videos[0].video
                                            .videoHeight
                                    });
                                }
                                else {
                                    ...
                                    var firefoxSettings = publisher.stream
                                        ...
                                        .getVideoTracks()[0]
                                        .getSettings();
                                    var newWidth = ((platform.name.toLowerCase().indexOf("firefox") !== -1
                                        ? firefoxSettings.width
                                        : publisher.videoReference.videoWidth));
                                    var newHeight = ((platform.name.toLowerCase().indexOf("firefox") !== -1
                                ...
                                _this.sendRequest("streamPropertyChanged", {
                                    ...
                                    if (error) {
                                        ...
                                        _this.session.emitEvent("streamPropertyChanged", [
                                            new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(_this.session, publisher.stream, "videoDimensions", publisher.stream.videoDimensions, { width: oldWidth, height: oldHeight }, "deviceRotated"),
                                        ]);
                                        publisher.emitEvent("streamPropertyChanged", [
                                            new StreamPropertyChangedEvent_1.StreamPropertyChangedEvent(publisher, publisher.stream, "videoDimensions", publisher.stream.videoDimensions, { width: oldWidth, height: oldHeight }, "deviceRotated"),
                                        ]);
                                    }
                                });
                                clearTimeout(repeatUntilChange_1);
    ...
    OpenVidu.prototype.initPublisher = function (targetElement, param2, param3) {
        ...
        if (!!param2 && typeof param2 !== "function") {
            ...
            properties = param2;
            properties = {
                audioSource: typeof properties.audioSource !== "undefined"
                    ? properties.audioSource
                    : undefined,
                frameRate: typeof MediaStreamTrack !== "undefined" &&
                ...
                publishAudio: typeof properties.publishAudio !== "undefined"
                    ? properties.publishAudio
                    : true,
                publishVideo: typeof properties.publishVideo !== "undefined"
                    ? properties.publishVideo
                    : true,
                resolution: typeof MediaStreamTrack !== "undefined" &&
                    properties.videoSource instanceof MediaStreamTrack
                    ? undefined
                    : typeof properties.resolution !== "undefined"
                        ? properties.resolution
                        : "640x480",
                videoSource: typeof properties.videoSource !== "undefined"
    ...
    OpenVidu.prototype.getDevices = function () {
        return new Promise(function (resolve, reject) {
            navigator.mediaDevices
                ...
                if (platform["isIonicAndroid"] &&
                    typeof cordova != "undefined" && ((_a = cordova === null || cordova === void 0 ? void 0 : cordova.plugins) === null || _a === void 0 ? void 0 : _a.EnumerateDevicesPlugin)) {
            ...
            _this.generateMediaConstraints(options)
                ...
                if ((!!myConstraints.videoTrack && !!myConstraints.audioTrack) ||
                    (!!myConstraints.audioTrack &&
                        ((_a = myConstraints.constraints) === null || _a === void 0 ? void 0 : _a.video) === false) ||
                    (!!myConstraints.videoTrack &&
                        ((_b = myConstraints.constraints) === null || _b === void 0 ? void 0 : _b.audio) === false)) {
    ...
    OpenVidu.prototype.generateMediaConstraints = function (publisherProperties) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (myConstraints.constraints.audio === false &&
                myConstraints.constraints.video === false) {
        ...
        if (typeof videoSource === "string") {
            if (!this.isScreenShare(videoSource)) {
                ...
                if (!this.checkScreenSharingCapabilities()) {
                    var error = new OpenViduError_1.OpenViduError(OpenViduError_1.OpenViduErrorName.SCREEN_SHARING_NOT_SUPPORTED, "You can only screen share in desktop Chrome, Firefox, Opera, Safari (>=13.0) or Electron. Detected client: " +
                        platform.name);
                    logger.error(error);
                    reject(error);
                }
                    ...
                    if (platform.name === "Electron") {
                        ...
                        if (!!this.advancedConfiguration.screenShareChromeExtension &&
                                    ...
                                    if (error === "permission-denied" ||
                                        ...
                                        screenSharing.getChromeExtensionStatus(extensionId, function (status) {
                                            ...
                                            if (status === "not-installed") {
                                                var error_3 = new OpenViduError_1.OpenViduError(OpenViduError_1.OpenViduErrorName.SCREEN_EXTENSION_NOT_INSTALLED, (_this.advancedConfiguration
                            ...
                            if (navigator.mediaDevices["getDisplayMedia"]) {
                                ...
                                var firefoxString = platform.name.indexOf("Firefox") !== -1
