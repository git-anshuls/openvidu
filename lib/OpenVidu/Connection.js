...
var Connection = /** @class */ (function () {
    ...
    Connection.prototype.sendIceCandidate = function (candidate) {
        logger.debug((!!this.stream.outboundStreamOpts ? "Local" : "Remote") +
            "candidate for" +
    ...
    Connection.prototype.initRemoteStreams = function (options) {
        ...
        logger.info("Remote 'Connection' with 'connectionId' [" +
            this.connectionId +
            "] is now configured for receiving Streams with options: ", this.stream.inboundStreamOpts);
    };
    /**
     * @hidden
     */
